...
import com.ansorkazama.udacity_baking_recipe_apps.presenter.RecipeListPresenterViewContract;
import com.ansorkazama.udacity_baking_recipe_apps.databinding.FragmentRecipeListBinding;
import com.ansorkazama.udacity_baking_recipe_apps.model.Recipe;
import com.ansorkazama.udacity_baking_recipe_apps.networking.UdacityNetworkService;
import com.ansorkazama.udacity_baking_recipe_apps.adapter.RecipeAdapter;

import java.util.ArrayList;

public class RecipeListFragment extends Fragment
        implements RecipeListPresenterViewContract.View {
    private final String INS_KEY_RECIPE_LIST = "instance_key_recipe_list";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(INS_KEY_RECIPE_LIST)) {
                mRecipeList = savedInstanceState.getParcelableArrayList(INS_KEY_RECIPE_LIST);
            }
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putParcelableArrayList(INS_KEY_RECIPE_LIST, mRecipeList);
